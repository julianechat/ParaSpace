...
colnames(trans.mod)[c(14:21, 30:32)] <- c("Temp.T", "Cond.T", "DO.T", "Turb.T", "pH.T", 
                                   "TOC.T", "TN.T", "TP.T",
...
trans.mod <- merge(trans.mod, LakeBiotic, by.x = "Lake") 
colnames(trans.mod)[c(41:43)] <- c("Centrarchids.L", "Species_richness.L", "Diversity.L")
trans.mod <- trans.mod %>% 
